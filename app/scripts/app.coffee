...
@feedmeseymoreApp = angular.module('feedmeseymoreApp', ['ngCookies', 'ngResource', 'ngSanitize', 'ui.router', 'com.2fdevs.videogular', "com.2fdevs.videogular.plugins.poster", 'google-maps'])
